        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/Friends_worlds01) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
async def alive(client, message: Message):
    await message.reply_photo(
        photo=f"https://te.legra.ph/file/940e70c112997c9526b1d.jpg",
        caption=f"""━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ ʜᴇʟʟᴏ, ᴍᴀᴍʙᴀ ɪs ᴡᴏʀᴋɪɴɢ ᴀɴᴅ ғᴜɴᴄᴛɪᴏɴɪɴɢ ᴘʀᴏᴘᴇʀʟʏ\n✪ ᴛʜᴀɴᴋs ᴛᴏ ʏᴜᴋᴋɪ ᴛᴇᴀᴍ 🌼 ..\n\n┏━━━━━━━━━━━━━━━━━┓\n┣★ ᴏᴡɴᴇʀ    : [ᴍᴀᴍʙᴀ](https://t.me/ITZ_ME_BLACKMAMBA)\n┣★ ᴜᴘᴅᴀᴛᴇs › : [ᴍᴀᴍʙᴀ ᴜᴘᴅᴀᴛᴇ](https://t.me/MAMBA_UPDATES)┓\n┣★ ʀᴇᴘᴏ › : [ᴍᴀᴍʙᴀ ʀᴇᴘᴏ](https://github.com/FantasticSukhi/Mambab)\n┗━━━━━━━━━━━━━━━━━┛\n\n💞 ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴛʜᴇɴ\nᴅᴍ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](https://t.me/ITZ_ME_BLACKMAMBA) ᴍᴀᴋᴇ sᴜʀᴇ ᴛᴏ sᴛᴀʀ ᴏᴜʀ ᴘʀᴏᴊᴇᴄᴛ ...\n\n━━━━━━━━━━━━━━━━━━━━━━━━""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 ᴍᴀᴍʙᴀ ᴄʜᴀᴛ 💮", url=f"https://t.me/Mamba_Music_help")]]
        ),
    )
...
async def verify(client, message: Message):
    ...
    await message.reply_photo(
        photo=f"https://te.legra.ph/file/940e70c112997c9526b1d.jpg",
        caption=f"""━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ **ᴄᴏɴɢʀᴀᴛᴜʟᴀᴛɪᴏɴ** 🎉\n✪ ɴᴏᴡ ʏᴏᴜ ᴀʀᴇ ᴍᴀᴍʙᴀ ᴠᴇʀɪғɪᴇᴅ ᴍᴇᴍʙᴇʀ ɢᴏ ʙᴀᴄᴋ ᴀɴᴅ ᴇɴᴊᴏʏ ᴏᴜʀ sᴇʀᴠɪᴄᴇ ᴀɴᴅ ᴘʟᴀʏ ᴍᴜsɪᴄ 🌼 ..\n\n━━━━━━━━━━━━━━━━━━━━━━━━""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 ᴍᴀᴍʙᴀ ᴄʜᴀᴛ 💮", url=f"https://t.me/Mamba_Music_help")]]
        ),
    )
